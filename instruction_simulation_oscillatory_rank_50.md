...
Previous exploration on the original oscillatory config found optimal training params: `lr_k=0.005`, `lr_node=0.001`, `lr_sub=0.0005`, `coeff_MLP_sub_diff=3-5`, `data_augmentation_loop=2000`. These are used as starting values but may need re-tuning for the higher-rank regime.
